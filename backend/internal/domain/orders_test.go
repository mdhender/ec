	...
	tests := []struct {
	...
	}{
		{
			...
			order: domain.SetUpOrder{
				...
				NewKind:   domain.UnitSpec{Kind: domain.Factory},
			},
		},
		{
			...
			order: domain.BuildChangeOrder{
				...
				ColonyID:       1,
				FactoryGroupID: 2,
				NewUnit:        domain.UnitSpec{Kind: domain.Mine},
			},
		},
		{
		...
		},
		{
			...
			order: domain.TransferOrder{
				...
				SourceID:  1,
				DestID:    2,
				Unit:      domain.UnitSpec{Kind: domain.Food},
				Quantity:  100,
			},
		},
		{
			...
			order: domain.AssembleOrder{
				...
				ColonyID:  1,
				Unit:      domain.UnitSpec{Kind: domain.Factory},
				Quantity:  5,
			},
		},
		{
